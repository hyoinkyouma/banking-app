...
const withdraw = async (balance, amount, id, transactionLogging) => {
  const current = await fetch(
    "https://banking-app-avion.herokuapp.com/deposit",
    {
      method: "POST",
      body: JSON.stringify({
...
const transfer = async (
  ...
  const current = await fetch(
    "https://banking-app-avion.herokuapp.com/transfer",
    {
      method: "post",
      headers: { "Content-type": "application/json" },
      body: JSON.stringify({
...
const budgetLogging = async (name, id, amount) => {
  return await fetch("https://banking-app-avion.herokuapp.com/logBudget", {
    method: "post",
    headers: { "Content-type": "application/json" },
...
const transactionLogging = async (transType, balance, amount, current) => {
  const res = await fetch(
    "https://banking-app-avion.herokuapp.com/logTransaction",
    {
      method: "post",
      headers: { "Content-type": "application/json" },
      body: JSON.stringify({
